...
class TTTGame(Frame):
	...
	# This method is basically a wrapper for the TicTacToe AI that also updates the canvas
	def gameBotMove(self):
		self.gameBoard.botMove('O')
		self.updateCanvas()
		self.turn = 0
	# Clears canvas, resets board, resets turn, resets gameOver, creates game
	def newGame(self):
